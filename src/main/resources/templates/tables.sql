...
CREATE TABLE announcement (
    ...
    `type` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '类型 0日历 1菜单 2活动 3后勤 4园区',
    `worker_id` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'id',
